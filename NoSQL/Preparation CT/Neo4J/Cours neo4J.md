...
1. **Scalabilité horizontale (Scaling Out)** :
...
2. **Scalabilité verticale (Scaling Up)** :
...
### Limites des bases de données relationnelles pour la scalabilité
...
### Principe CAP : Choix dans les Systèmes Distribués
...
### Compromis CAP dans les Bases de Données
...
### Représentation des Systèmes NoSQL et Cas d'Usage
...
#### Exemples de Systèmes et Prouvés Conceptuellement
...
#### Exemples d’Utilisation de NoSQL par les Grandes Entreprises
...
### Positionnement de Neo4j dans le NoSQL
...
### Structures de Support et Représentation en Graphe
...
#### Forces des bases de données graphes
...
#### Modèle général des graphes (Property Graph Model)
